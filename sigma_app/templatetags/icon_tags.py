...
Available icons: user, trash, plus, home, x, search, filter
"""
...
def icon(name, size='md', color='primary', css_class='', **kwargs):
    ...
    Args:
        name: Icon name (user, trash, plus, home, x, search, filter)
    ...
    svg = f'''<svg xmlns="http://www.w3.org/2000/svg" width="{size_value}" height="{size_value}" viewBox="0 0 24 24"{class_str}{attrs_str}>
  {icon_path}
</svg>'''
